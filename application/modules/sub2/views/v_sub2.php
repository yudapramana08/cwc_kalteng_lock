  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0 text-dark">SUB 2</h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
                  ...
                  <tbody>
                    ...
                    foreach ($data->result_array() as $i) : ?>
                      <tr>
                        ...
                        <td>
                          <?php
                          $sub1 = $this->m_utama->sub1ById($i['id_sub1']);
                          $kat = $this->m_utama->kategoriById($sub1['id_kategori']);

                          echo $kat['kategori'] . '->' . $sub1['sub'];
                          ?></td>
                        ...
                        <td>
                          ...
                          |
                          <a onclick="return confirm('Yakin Hapus ?')" class='btn btn-danger btn-sm' title='Hapus Data' data-toggle="tooltip" href='<?php echo base_url() . 'sub2/hapus/' . $i['id'] ?>'>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <form action="<?php echo base_url() . 'sub2/updatesub2' ?>" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      ...
                                      <div class="col-sm-7"><input type="text" class="form-control" name="sub2" value="<?php echo $i['sub']; ?>" required></div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form action="<?php echo base_url() . 'sub2/insertsub2' ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <div class="row">
                    <label class="col-sm-3 control-label text-left">Kategori<span class="text-red">*</span></label>
                    <div class="col-sm-7">
                ...
                <div class="form-group">
                  <div class="row">
                    <label class="col-sm-3 control-label text-left">Sub 2 <span class="text-red">*</span></label>
                    <div class="col-sm-7"><input type="text" class="form-control" name="sub2" required></div>
                  </div>
                </div>
                <div class="modal-footer">
                  <button id="nosave" type="button" class="btn btn-danger pull-left" data-dismiss="modal">Batal</button>

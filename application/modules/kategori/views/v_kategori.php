                    ...
                    foreach ($data->result_array() as $i) : ?>
                      <tr>
                        ...
                        <td>
                          ...
                          |
                          <a onclick="return confirm('Yakin Hapus ?')" class='btn btn-danger btn-sm' title='Hapus Data' data-toggle="tooltip" href='<?php echo base_url() . 'kategori/hapus/' . $i['id'] ?>'>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <form action="<?php echo base_url() . 'kategori/updatekategori' ?>" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      ...
                                      <div class="col-sm-7"><input type="text" class="form-control kategori" name="kategori" value="<?php echo $i['kategori']; ?>" id="kategori" required></div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form action="<?php echo base_url() . 'kategori/insertkategori' ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <div class="row">
                    <label class="col-sm-3 control-label text-left">Kategori <span class="text-red">*</span></label>
                    <div class="col-sm-7"><input type="text" class="form-control kategori" name="kategori" id="kategori" required></div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
